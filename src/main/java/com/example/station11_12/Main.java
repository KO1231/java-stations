...
public class Main {
    ...
    public class Item {
        ...
        public Item(String name, int price, String category, String[] tags) {
            this.name = name;
            this.price = price;
        ...
        public float getPriceWithTax(final boolean isKeigenzeiritu) {
            return isKeigenzeiritu ? price * 1.08f : price * 1.10f;
